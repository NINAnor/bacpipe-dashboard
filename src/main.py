...
from tabs import data_tab, original_tab, fine_tune_tab, proto_tab, compare_tab
...
def run_dashboard(cfg):
    ...
    data_tab_ui, original_tab_ui, finetune_tab_ui, proto_tab_ui, compare_tab_ui = st.tabs([
    ...
    with finetune_tab_ui:
        fine_tune_tab.render(model_changed, test_size_changed, hidden_dim_changed, epochs_changed)
    
    with proto_tab_ui:
        proto_tab.render(model_changed, test_size_changed, hidden_dim_changed, epochs_changed)
